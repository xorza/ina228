//! The driver itself: [`Ina228`] and the values it hands back.

use embedded_hal::i2c::I2c;

use crate::adc_config::{AdcConfig, AdcConfigWord};
use crate::adc_range::AdcRange;
use crate::calibration::Calibration;
use crate::config::Config;
use crate::diag_alrt::{AlertConfig, DiagnosticFlags};
use crate::error::{CaptureError, ConfigurationError, Error, InitializationError};
...
impl<I2C: I2c> Ina228<I2C> {
    ...
    pub fn configure_alerts(&mut self, cfg: AlertConfig) -> Result<(), Error<I2C::Error>> {
        Ok(self.write_u16(Register::DiagAlrt, cfg.bits())?)
    }
